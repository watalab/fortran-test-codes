program diff2dSOR
    ...
    do t=1, tmax-1
        ...
        do l=1,itermax
            ...
            do j=2,nmax-1
                do i=2,nmax-1
                    u(i,j, t+1) = (1.0-omega)*utemp(i,j) + & 
                    omega*(u(i,j,t) +nu*utemp(i+1,j) + nu*u(i-1,j, t+1) + nu*u(i, j-1, t+1) + nu*utemp(i,j+1))/(1.0+4.0*nu)
            ...
            do j=2,nmax-1
                do i=2,nmax-1
                    res = res + abs((utemp(i,j) - u(i,j,t+1))/(u(i,j,t+1)+1e-10))
                enddo
            enddo
